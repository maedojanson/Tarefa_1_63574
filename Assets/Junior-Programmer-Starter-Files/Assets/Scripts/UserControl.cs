    ...
    private void Update()
    {
        ...
        if (Input.GetMouseButtonDown(0))
        {
            ...
            if (Physics.Raycast(ray, out hit))
            {
                ...
                // ✨ CORRIGIDO: Alterado de SetNewInfoContent para SetNewContent para bater certo com a tua UI!
                if (UIMainScene.Instance != null)
                {
                    UIMainScene.Instance.SetNewContent(uiInfo);
                }
            }
        }
